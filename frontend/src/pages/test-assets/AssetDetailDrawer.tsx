...
import { Drawer, Descriptions, Tag, Badge, Card, Button, Space, message, Table, Empty } from 'antd';
import {
...
export default function AssetDetailDrawer({ assetId, visible, onClose, onRefresh }: Props) {
