...
import { EyeOutlined, CheckCircleOutlined, SearchOutlined, ReloadOutlined, PlayCircleOutlined } from '@ant-design/icons';
...
export default function DraftPage({ onDetail }: Props) {
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.published) {
        message.success(`发布 ${data.count} 条`);
        setSelectedRowKeys([]);
        fetchData();
      }
