"""Launch production Core E2E using gitignored runtime credentials. Never prints secrets."""
...
def main() -> None:
    ...
    print("E2E_TARGET", "http://localhost:8000")
    print("E2E_STACK", "deploy/docker/docker-compose.prod.yml")
    runpy.run_path(str(Path(__file__).with_name("e2e_phase3.py")), run_name="__main__")
